      ...
      <Card className="w-full shadow-sm hover:shadow-md transition-all duration-200">
        ...
        <CardContent className="space-y-6 sm:space-y-8 p-4 sm:p-5 lg:p-6 pt-0 sm:pt-0 lg:pt-0">
          <div className="space-y-4">
            {/* Email Notifications */}
            <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3 sm:gap-4 p-4 sm:p-5 border rounded-lg hover:bg-muted/50 transition-colors">
              <div className="flex items-start gap-3 sm:gap-4">
                <Mail className="h-5 w-5 sm:h-6 sm:w-6 mt-1 text-muted-foreground" />
                <div className="space-y-1 sm:space-y-2 flex-1">
                  ...
                  <p className="text-sm sm:text-base text-muted-foreground">
                    Receive email notifications for bug reports and status
                    changes (Global Setting)
                  </p>
                </div>
              </div>
              <Switch
                ...
                className="self-start sm:self-center scale-110 sm:scale-125"
              />
            </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3 sm:gap-4 p-4 sm:p-5 border rounded-lg hover:bg-muted/50 transition-colors">
              <div className="flex items-start gap-3 sm:gap-4">
                <Bell className="h-5 w-5 sm:h-6 sm:w-6 mt-1 text-muted-foreground" />
                <div className="space-y-1 sm:space-y-2 flex-1">
                  <Label
            ...
            <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3 sm:gap-4 p-4 sm:p-5 border rounded-lg hover:bg-muted/50 transition-colors">
              <div className="flex items-start gap-3 sm:gap-4">
                <MessageCircle className="h-5 w-5 sm:h-6 sm:w-6 mt-1 text-muted-foreground" />
                <div className="space-y-1 sm:space-y-2 flex-1">
                  <Label
            ...
            <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3 sm:gap-4 p-4 sm:p-5 border rounded-lg hover:bg-muted/50 transition-colors">
              <div className="flex items-start gap-3 sm:gap-4">
                <Volume2 className="h-5 w-5 sm:h-6 sm:w-6 mt-1 text-muted-foreground" />
                <div className="space-y-1 sm:space-y-2 flex-1">
                  <Label
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-yellow-700 mt-1">
                        Enable email, browser, or WhatsApp notifications to
                        receive alerts about bug activities.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-3 text-xs">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      • Reset Check Time: Forces polling to check all recent
                      notifications
                      <br />
                      • Force Check Now: Manually triggers notification check
                      <br />• Check Status: Shows current polling and settings
                      status
                    </p>
                  </div>
                </div>
