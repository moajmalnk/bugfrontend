          ...
          <div className="flex gap-2 w-full sm:w-auto">
            ...
            {canDelete && (
              <Button 
                ...
                disabled={isDeleting}
                className="flex-1 sm:flex-none h-8 sm:h-9 text-xs sm:text-sm border-red-200 text-red-600 hover:bg-red-50 hover:border-red-300 dark:border-red-800 dark:text-red-400 dark:hover:bg-red-900/20"
              >
