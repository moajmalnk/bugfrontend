...
const Clients = () => {
  ...
  useEffect(() => {
    ...
    if (statusTabs.length > 0 && !statusTabs.some((t) => t.value === tabFromUrl)) {
      ...
      params.set('tab', statusTabs[0].value);
      params.delete('page');
      if (params.toString() === searchParams.toString()) return;
      setSearchParams(params, { replace: true });
    }
  }, [isLoading, clients.length, statusTabs, tabFromUrl, searchParams, setSearchParams]);
  ...
  useResetUrlPageOnChange(setCurrentPage, [searchTerm, activeTab]);
                        ...
                        >
                          ...
                          <TableCell className="px-6 py-5 text-right">
                            <button
                              ...
                              onClick={() => navigate(`/${role}/clients/${client.id}`, { state: listFromState })}
                            >
                              View
                            </button>
                          </TableCell>
